    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 px-6 py-3 rounded-lg bg-primary text-secondary font-semibold hover:bg-primary-hover hover:cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        {onCancel && (
          <button
            ...
            className="px-6 py-3 rounded-lg bg-primary text-secondary font-semibold hover:bg-primary-hover hover:cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
        )}
